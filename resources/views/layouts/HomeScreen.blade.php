  ...
  <body id="page-top">
    ...
    <section id="about" class="about-section text-center">
      <div class="container">
        ...
        <img src="{{asset('/startbootstrap-grayscale-gh-pages/img/ipad.png')}}" class="img-fluid" alt="">
      </div>
    </section>
      ...
      <div class="container">
        ...
        <div class="row align-items-center no-gutters mb-4 mb-lg-5">
          <div class="col-xl-8 col-lg-7">
            <img class="img-fluid mb-3 mb-lg-0" src="{{asset('/startbootstrap-grayscale-gh-pages/img/bg-masthead.jpg')}}" alt="">
          </div>
        ...
        <div class="row justify-content-center no-gutters mb-5 mb-lg-0">
          <div class="col-lg-6">
            <img class="img-fluid" src="{{asset('/startbootstrap-grayscale-gh-pages/img/demo-image-01.jpg')}}" alt="">
          </div>
          <div class="col-lg-6">
        ...
        <div class="row justify-content-center no-gutters">
          <div class="col-lg-6">
            <img class="img-fluid" src="{{asset('/startbootstrap-grayscale-gh-pages/img/demo-image-02.jpg')}}" alt="">
          </div>
