...
<head>
    ...
    <!-- Morris Charts CSS -->
    <link href="{{asset('/sb admin dua/vendor/morrisjs/morris.css') }}" rel="stylesheet">
...
<body>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="{{url('/dataCustomer')}}"><i class="fa fa-dashboard fa-fw"></i> Customer</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="{{url('/dataCustomer')}}"><i class="fa fa-table fa-fw"></i> Tables</a>
                        </li>
                        <li>
    ...
    <script src="{{asset('/sb admin dua/vendor/raphael/raphael.min.js') }}"></script>
    <script src="{{asset('/sb admin dua/vendor/morrisjs/morris.min.js') }}"></script>
    <script src="{{asset('/sb admin dua/data/morris-data.js') }}"></script>
